 ...
 * (spec §2.5).
 *
 * <p>Three forms, and the third is §6.4's: a constant, a reference to a bound fact's field, or an
 * expression computed at fire time. {@link ExpressionValue} says why the last one exists.
 *
 ...
 */
public sealed interface ValueExpr permits Literal, FieldRef, ExpressionValue {}
